...
public class CliModelsHandler extends BaseMessageHandler {
    ...
    public boolean handle(String type, String content) {
        ...
        if (!"opencode".equals(provider) && !"kimi".equals(provider) && !"pi".equals(provider) && !"omp".equals(provider) && !"codex".equals(provider) && !"grok".equals(provider) && !"dsh".equals(provider)) {
